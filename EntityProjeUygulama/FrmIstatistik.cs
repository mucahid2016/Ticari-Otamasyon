...
namespace EntityProjeUygulama
{
    public partial class FrmIstatistik : Form
    {
        ...
        {
            label2.Text = db.TBLKATEGORı.Count().ToString();
            ...
            label21.Text = db.TBLSATIS.Sum(z => z.FIYAT).ToString();
            label9.Text = (from x in db.TBLURUN orderby x.FIYAT descending select x.URUNAD).FirstOrDefault();
            label11.Text = (from x in db.TBLURUN orderby x.FIYAT ascending select x.URUNAD).FirstOrDefault();
